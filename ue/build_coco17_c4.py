"""P1：C4 JSONL → COCO17（3D world + 2D projected）。
...
读：
  - pose_capture_c4.jsonl（11700 行：root/shot/game_time/actor_id/bone/x/y/z/qx/qy/qz/qw，cm）
  - camera.json（投影参数，世界米）
写：
  - coco17_3d_c4.jsonl  每帧一行 {root, keypoints_3d_m: [[x,y,z]×17]}
  - coco17_2d_c4.jsonl  每帧一行 {root, keypoints_2d_px: [[x,y]×17], visible: [bool×17]}
...
OUT_3D = EP / "coco17_3d_c4.jsonl"
OUT_2D = EP / "coco17_2d_c4.jsonl"
